  ...
  for (var i = 0; i < this.board.length; i++) {
    ...
    if (this.board[i].owner == this.player) {
      ...
      if (this.board[i].down && this.board[i].down.owner == null) {
        ...
        board[i].owner = null;
        board.lastMove = this.board.indexOf(this.board[i].down);
        states.push(board);
        board = this.cloneBoard();
      }
      ...
      if (this.board[i].right && this.board[i].right.owner == null) {
        ...
        board[i].owner = null;
        board.lastMove = this.board.indexOf(this.board[i].right);
        states.push(board);
        board = this.cloneBoard();
      }
      ...
      if (this.board[i].up && this.board[i].up.owner == null) {
        ...
        board[i].owner = null;
        board.lastMove = this.board.indexOf(this.board[i].up);
        states.push(board);
        board = this.cloneBoard();
      }
      ...
      if (this.board[i].left && this.board[i].left.owner == null) {
        ...
        board[i].owner = null;
        board.lastMove = this.board.indexOf(this.board[i].left);
        states.push(board);
      }
